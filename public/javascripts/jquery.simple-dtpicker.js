	...
	**/
	...
	PickerHandler.prototype._relocate = function(){
		...
		if ($input != null && $picker.data('isInline') === false) { // Float mode
			...
			// Display on most top of the z-index1
			$picker.parent().css('z-index1', 100000);
		}
	};
...
//选择日期
$(function(){
	$('input[id=date01]').appendDtpicker({
...
$(function(){
	$('input[id=date02]').appendDtpicker({ 
		"closeOnSelected":true,
		"locale":"cn",
		"autodateOnStart":false
	});
...
$(function(){
	$('input[id=date03]').appendDtpicker({
		"closeOnSelected":true,
		"locale":"cn",
		"autodateOnStart":false,
		"dateOnly": true,
...
$(function(){
	$('input[id=date04]').appendDtpicker({ 
		"closeOnSelected":true,
		"locale":"cn",
		"autodateOnStart":false,
		"dateOnly": true,
