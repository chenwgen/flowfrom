...
Calendar.prototype.style = function(){
	...
	strStyle += ".calendar {font-size:12px; margin:0;padding:0px;border:1px solid #c8c8c8;background-color:#eeeeee;}";
	...
	strStyle += ".today{ background:#99d5ff;padding:2px 3px;}";
...
document.write('<div id="calendarPanel" style="position:absolute;visibility:hidden;z-index1:9999;font-size:12px;width:26px;">');
